 ...
 */
package com.hemmerling.aufgabe01c_personenVerwaltung_v1;
...
@WebServlet(name = "FrontController", urlPatterns = {"/FrontController"},
        initParams = {
            @WebInitParam(name = "ITEMS", value = "items")
            ,
                            @WebInitParam(name = "VORNAME", value = "vorname")
            ,
                            @WebInitParam(name = "NACHNAME", value = "nachname")}
)
